...
class DemoProductionSuite(ProductionReadinessSuite):
    ...
    def _build_production_corpus(self):
        ...
        # Reduce fixtures
        corpus['controlled_fixtures']['duplicates'] = corpus['controlled_fixtures']['duplicates'][:3]
        corpus['controlled_fixtures']['stale_items'] = corpus['controlled_fixtures']['stale_items'][:3]
    ...
    async def phase6_soak(self):
        ...
        memory_trend = self._analyze_trend(memory_samples) if len(memory_samples) > 1 else 0

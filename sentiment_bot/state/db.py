...
class SentimentDB:
    ...
    def _init_schema(self):
        ...
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_aspects_text ON aspects(aspect_text)"
        )
    ...
    def get_time_series(
        self, hours: int = 24, region: Optional[str] = None, topic: Optional[str] = None
    ) -> List[Dict]:
    ...
    def get_trending_aspects(
        self, hours: int = 24, region: Optional[str] = None, limit: int = 10
    ) -> List[Dict]:

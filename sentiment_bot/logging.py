...
class PerformanceLogger:
    ...
    def log_timing(self, operation: str, duration_ms: int, metadata: Optional[Dict[str, Any]] = None):
        ...
        # Log if slow
        if duration_ms > 1000:
            self.logger.warning(f"[STATS] Slow {operation}: {duration_ms}ms {metadata or ''}")

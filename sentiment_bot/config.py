    ...
    class Settings:  # type: ignore[no-redef]
        ...
        RSS_FEEDS: List[str] = field(
            default_factory=lambda: [
                ...
                # Regional Security Focus
                "https://amwaj.media/rss",
                "https://www.mei.edu/rss.xml",
                "https://besacenter.org/feed/",
        ...
        OPENAI_API_KEY: str = os.getenv("OPENAI_API_KEY", "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")

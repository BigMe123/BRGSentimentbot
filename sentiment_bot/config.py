...
try:  # pragma: no cover - optional dependency
    ...
    class Settings(BaseSettings):
        ...
        FAST_FETCH_WORKERS: int = 100
        FAST_RENDER_WORKERS: int = 6
        FAST_PARSE_WORKERS: int = 8
        FAST_BROWSER_POOL_SIZE: int = 5
    ...
    class Settings:  # type: ignore[no-redef]
        ...
        FAST_FETCH_WORKERS: int = int(os.getenv("FAST_FETCH_WORKERS", "100"))

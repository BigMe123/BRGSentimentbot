...
class SarcasmDetector:
    ...
    def _detect_with_heuristics(self, text: str) -> float:
        ...
        if re.search(r'["\'].*\b(great|wonderful|amazing|excellent|perfect)\b.*["\']', text_lower):
            score += 0.3
    ...
    def adjust_sentiment_for_sarcasm(self, sentiment_score: float, sarcasm_prob: float) -> float:

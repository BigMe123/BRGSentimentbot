...
class ContentFilter:
    ...
    def canonicalize_url(self, url: str) -> str:
        ...
        tracking_params = {
            ...
            'fbclid', 'gclid', 'ref', 'source', 'sr_share', 'sfmc_id', 'sfmc',
            '_ga', '_gid', 'mc_cid', 'mc_eid', 'mkt_tok',
        }
    ...
    def filter_and_weight(self, articles: List[Dict[str, Any]]) -> List[ArticleMetadata]:
        """
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        if total_words > 0:
            ...
            sorted_shares = sorted(word_shares.items(), key=lambda x: x[1], reverse=True)

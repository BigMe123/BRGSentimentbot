...
[ Quick Start](#-quick-start-guide) • [ Platform Overview](#-platform-overview) • [ Architecture](#-complete-system-architecture) • [ Performance](#-comprehensive-performance-benchmarks) • [ Use Cases](#-comprehensive-use-cases) • [ Documentation](#-complete-documentation-index)
...
────────────────────────────────────────────────────────────
MAE (pp) 1.527 1.445 1.452 [SUCCESS]
RMSE (pp) 2.927 2.818 2.834 [SUCCESS]
sMAPE (%) 55.08% 54.72% 53.34% [SUCCESS]
Bias (pp) -0.739 -0.718 -0.698 [SUCCESS]
Std Dev (pp) 2.832 2.725 2.750 [SUCCESS]
────────────────────────────────────────────────────────────
DM Test vs Raw: - - p=0.0174* [SUCCESS]
DM Test vs Cons: - - p=0.3515 [SUCCESS]
Improvement: - - +4.9% [SUCCESS]
════════════════════════════════════════════════════════════
```
...
for country in results:
 ...
 print(f"├── Political: {country['political']['score']:+.3f} "
 f"(Confidence: {country['political']['confidence']:.2f})")
 print(f"└── Security: {country['security']['score']:+.3f} "
...
├── Political: -0.156 (Confidence: 0.76)
│ └── Drivers: election_uncertainty, polarization
└── Security: +0.521 (Confidence: 0.94)
 └── Drivers: defense_spending, nato_leadership

 China (CHN)
├── 💰 Economic: +0.234 (Confidence: 0.82)
├── Political: -0.089 (Confidence: 0.71)
└── Security: -0.345 (Confidence: 0.88)
```
...
|---|-----------|------|----------|-------|----------|
| 1 | **Google News** | News Aggregator | Global editions, custom queries | Fast | [ERROR] No |
| 2 | **Reddit RSS** | Social Media | Subreddit feeds, comments optional | Fast | [ERROR] No |
| 3 | **HackerNews** | Tech News | Top stories, Firebase API | Fast | [ERROR] No |
| 4 | **YouTube RSS** | Video Platform | Channel feeds, transcripts optional | Fast | [ERROR] No |
| 5 | **Wikipedia** | Encyclopedia | Article search, dynamic content | Medium | [ERROR] No |
| 6 | **GDELT** | Global Events | 250M+ events, full-text search | Fast | [ERROR] No |
| 7 | **Twitter/snscrape** | Social Media | Search, users, hashtags | Medium | [ERROR] No |
| 8 | **Mastodon** | Federated Social | Public timeline, hashtag search | Fast | [ERROR] No |
| 9 | **Bluesky** | Social Protocol | AT Protocol, feeds | Fast | [ERROR] No |
| 10 | **StackExchange** | Q&A Platform | Stack Overflow, 170+ sites | Fast | [ERROR] No |
| 11 | **News Aggregator** | Multi-Source | Combines multiple news APIs | Fast | [ERROR] No |
| 12 | **Web Search** | Generic Scraping | Custom CSS selectors | Slow | [ERROR] No |
| 13 | **Substack** | Newsletter Platform | RSS feeds, full content | Fast | [ERROR] No |
| 14 | **Medium** | Blogging Platform | Tag-based, user feeds | Fast | [ERROR] No |
| 15 | **GitHub** | Code Repository | Trending repos, issues | Fast | [ERROR] No |
| 16 | **Product Hunt** | Tech Discovery | Daily launches, collections | Fast | [ERROR] No |
...
───────────────────────────────────────────────────────────────────────────────
MAE (Mean Absolute Error) 1.527 1.445 1.452 -4.9% [SUCCESS]
RMSE (Root Mean Squared) 2.927 2.818 2.834 -3.2% [SUCCESS]
sMAPE (Symmetric MAPE) 55.08% 54.72% 53.34% -3.2% [SUCCESS]
Bias (Mean Error) -0.739 -0.718 -0.698 +5.5% [SUCCESS]
Std Dev (Volatility) 2.832 2.725 2.750 -2.9% [SUCCESS]
Max Error 6.234 5.892 5.923 -5.0% [SUCCESS]
Min Error -7.123 -6.834 -6.891 +3.3% [SUCCESS]
───────────────────────────────────────────────────────────────────────────────
...
───────────────────────────────────────────────────────────────────────────────
[SUCCESS] Matches institutional consensus (DM p=0.35, statistically equivalent)
[SUCCESS] Significantly better than raw model (DM p=0.02, +4.9% improvement)
[SUCCESS] Robust parameter estimation (CV=0.565, no significant drift)
[SUCCESS] Comprehensive validation (49 observations, 6 countries, 8 years)
[SUCCESS] Explainable AI (reason codes for every forecast)
[SUCCESS] Production hardening (guardrails, offline mode, CI validation)
═══════════════════════════════════════════════════════════════════════════════
```
...
│ Security: -0.345 ↓ (Confidence: 0.88) [WARNING] ALERT! │
│ └─ Drivers: Taiwan tensions, South China Sea │
│ Overall: -0.067 (Deteriorating) [WARNING] ALERT! │
└─────────────────────────────────────────────────────────────┘

[... similar for RUS, UKR, IRN, ISR ...]

[ALERT] ALERTS (last 24h)
─────────────────────────────────────────────────────────────
[WARNING] CHN Security: Dropped from -0.234 to -0.345 (-0.111)
[WARNING] UKR Political: Dropped from +0.456 to +0.312 (-0.144)
[WARNING] ISR Security: Dropped from -0.234 to -0.567 (-0.333)
─────────────────────────────────────────────────────────────
```
...
# Alert
 print(f"[WARNING] CRISIS ALERT: High volatility detected ({sentiment_volatility:.2f})")
...
**Built with by Boston Risk Group**
